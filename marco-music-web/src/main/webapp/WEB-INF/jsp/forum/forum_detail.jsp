	            ...
	            <div class="span8 page-content">		
                    <article class="type-post format-standard hentry clearfix">
	                    <h1 class="post-title">
	                    	...
	                    	<a href="javascript:void(0)" class="all-title-style" style="color: #f0b70c !important;">${forum[1]}</a>
	                    </h1>
	                    ...
	                    <div style="text-indent: 2rem; margin-bottom: 3rem;">${forum[2]}</div>
                    </article>
	                <section id="comments">	
		                            ...
		                            <article id="comment-4" class="article-style">	
		                                <a href="javascript:void(0)">
		                                	<c:choose>
							            		...
							            		<c:otherwise>
							            			<img src="${txURL}${forumReply[6] }" class="avatar avatar-60 photo tx-style5" />
							            		</c:otherwise>
							            	</c:choose> 
		                                </a>	
		                                <div class="comment-meta">
